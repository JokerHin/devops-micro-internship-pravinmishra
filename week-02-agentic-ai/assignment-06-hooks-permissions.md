...
![ `.claude` folder structure](screenshots/task-27-diagram.png)
...
![ `user-prompt-guard.sh](screenshots/task-28-diagram.png)
...
![`pre-tool-guard.sh`](screenshots/task-29-diagram.png)
...
![`pre-tool-guard.sh`](screenshots/task-30-diagram.png)
...
![`pre-tool-guard.sh`](screenshots/task-31-diagram.png)
...
![UserPromptSubmit hook blocking the destructive prompt](screenshots/task-32-diagram.png)
...
![PreToolUse hook blocking terraform destroy](screenshots/task-33-diagram.png)
...
![Claude running terraform validate successfully](screenshots/task-34-diagram.png)

#### Screenshot 9 — `.claude/deploy.log` showing the logged command

![Claude running terraform validate successfully](screenshots/task-35-diagram.png)
