...
![Space confirmation or Space sidebar showing the Space name and key](screenshots/task-6-diagram.png)
...
![Backlog showing the Epic panel enabled and the Epic visible](screenshots/task-7-diagram.png)
...
![Backlog showing the Epic and all six Stories under it](screenshots/task-8-diagram.png)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![One opened Story showing its Story point estimate, acceptance criteria, and label](screenshots/task-9-diagram.png)
...
![S2 showing all four Sub-tasks](screenshots/task-10-diagram.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![S4 showing all four Sub-tasks](screenshots/task-11-diagram.png)
...
![Backlog or Story details showing labels applied to at least two visible Stories](screenshots/task-12-diagram.png)
...
![Sprint 1 before starting, showing the selected Stories and Story Points](screenshots/task-13-diagram.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Active Sprint board showing the started Sprint and Sprint Goal](screenshots/task-14-diagram.png)
...
![Filter for label = frontend showing the filtered results](screenshots/task-15-diagram.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![Filter for label = devops showing the filtered results](screenshots/task-16-diagram.png)
...
![Burndown Chart page opened for Sprint 1](screenshots/task-17-diagram.png)
